...
public class InitializeDB {
	...
	private static ArrayList<String> startTablesArray() {
		...
		arrayList.add("create table COMPANIES ("
				+ "ID int not null primary key auto_increment,"
				+ "NAME varchar(255),"
				+ "EMAIL varchar(255),"
				+ "PASSWORD varchar(255))");
		
		arrayList.add("create table CUSTOMERS ("
				+ "ID int not null primary key auto_increment,"
		...
		arrayList.add("create table CATEGORIES ("
				+ "ID int not null primary key auto_increment,"
				+ "NAME varchar(255))");
		
		arrayList.add("create table COUPONS ("
				+ "ID int not null primary key auto_increment,"
				+ "COMPANY_ID int,"
				+ "CATEGORY_ID int,"
				+ "TITLE varchar(255),"
		...
		arrayList.add("create table CUSTOMERS_VS_COUPONS ("
				+ "CUSTOMER_ID int,"
				+ "COUPON_ID int)");
